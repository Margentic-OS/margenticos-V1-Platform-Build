...
-- Captured 2026-08-27 15:25 UTC from the LIVE database, read-only.
...
CREATE TRIGGER "users-pending-review-notify" AFTER INSERT ON public.users_pending_review FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://app.margenticos.com/api/webhooks/users-pending-review-notify', 'POST', '{"x-webhook-secret":"<REDACTED: set from SUPABASE_PENDING_REVIEW_WEBHOOK_SECRET>"}', '{}', '5000');
