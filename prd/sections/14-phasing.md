...
### Integrations (phase one)
  ...
  - [x] Booking link: stored per client (organisations.booking_url), used in positive reply emails; detection via Cal.com webhook (ADR-054)
...
Regardless of phase:
  ...
  - Booking system (Cal.com, ADR-054, or manual recording for any other tool)
