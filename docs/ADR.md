...
## ADR-054 — Booking detection moves to Cal.com through one signed webhook; an unmatched booking is recorded and never billed automatically; Calendly is removed
