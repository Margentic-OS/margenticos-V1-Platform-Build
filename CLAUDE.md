...
public view is the obvious next step and is tracked in the Notion Backlog as
"Revoke anon SELECT on the nine mon_* views" (Gate: Before first paying client).
That row also records that the closing migration is already written and NOT applied,
at supabase/migrations/20260826170000_revoke_anon_on_views.sql.
